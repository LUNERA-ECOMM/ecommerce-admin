...
export const useCategories = () => {
  ...
  useEffect(() => {
    ...
    // Fetch all categories from the storefront folder
...
export const useProductsByCategory = (categoryId) => {
  ...
  useEffect(() => {
    ...
    // Query products from the storefront folder, filter categoryIds and active client-side
    // Firestore doesn't allow multiple array-contains filters, so filter categoryIds client-side
